...
@click.option('--their-roster', '-o', type=str, default='rosters/andy_roster.csv', help='Specify path to their roster csv.')
@click.option('--my-stats', '-m', type=str, default='rob_stats.csv', help='Specify path to my stats csv.')
@click.option('--their-stats', '-t', type=str, default='andy_stats.csv', help='Specify path to their stats csv.')
