...
def optimize_lineups():
    ...
    # ranking_stats = common.get_stats_rankings("zstats_rankings.csv")
    ...
    # ranking_stats = build_team("rosters/lucas_roster.csv", ranking_stats)
    # ranking_14_stats = build_team("rosters/lucas_roster.csv", ranking_14_stats)
    stats = build_team("rosters/andy_roster.csv", stats)
    # ranking_stats = build_team("rosters/andy_roster.csv", ranking_stats)
    # ranking_14_stats = build_team("rosters/andy_roster.csv", ranking_14_stats)
    ...
    stats = build_team("rosters/jake_roster.csv", stats)
    # ranking_stats = build_team("rosters/jake_roster.csv", ranking_stats)
    # ranking_14_stats = build_team("rosters/jake_roster.csv", ranking_14_stats)
    #  ranking_7_stats = build_team("rosters/jake_roster.csv", ranking_7_stats)
    ...
    # ranking_stats = build_team("rosters/mark_roster.csv", ranking_stats)
    # ranking_14_stats = build_team("rosters/mark_roster.csv", ranking_14_stats)
    #  ranking_7_stats = build_team("rosters/mark_roster.csv", ranking_7_stats)
